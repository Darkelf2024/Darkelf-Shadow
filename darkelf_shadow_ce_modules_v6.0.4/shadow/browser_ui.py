...
class BrowserUIMixin:
    ...
    def show_quantum_status(self):
        ...
        print("=" * 60)
        print("Quantum button pressed")
        print("Profile id:", id(self.shared_profile))
        ...
        try:
            print("Checking Quantum status...")
            stats = pq.status_info()
            print("Quantum status OK")
            print(stats)

        except Exception as e:
            print("Quantum exception:", repr(e))
        ...
        try:
            print("Building Quantum HTML...")
            html = self._build_quantum_report_html(pq)
            print("HTML built")

        except Exception as e:
            print("Quantum HTML exception:", repr(e))
        ...
        # Use the shared browser profile instead of the default profile.
        ...
        try:
            ...
            print("QWebEngine exception:", repr(e))
