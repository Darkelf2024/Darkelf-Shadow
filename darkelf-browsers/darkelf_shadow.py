...
PROJECT SCOPE (EPHEMERAL SHADOW BUILD)

Darkelf Shadow is the hardened Qt-based edition of the Darkelf-Mini project,
...
• Network Privacy Enforcement
  ...
  interception layer (StealthInterceptor).
...
Darkelf Shadow is designed for defense-in-depth:

• HTTPS upgrade enforcement (where possible)
• Request-level filtering (EasyList + heuristic analysis)
• JavaScript execution control
• Optional fingerprint randomization and spoofing layers
...
for compliance with applicable export-control laws, including:

• U.S. Export Administration Regulations (EAR)
• License exceptions such as TSU (15 CFR §740.13(e))
...
This software may not be exported, re-exported, or transferred in violation of:
...
• Development or deployment of weapons of mass destruction (as defined by the EAR)

By using or distributing this software, you agree to comply with all applicable laws.
...
• Source code only — no compiled binaries are included.
• Redistribution and modification must comply with:
  - LGPL-3.0-or-later
  - Applicable export and usage regulations
